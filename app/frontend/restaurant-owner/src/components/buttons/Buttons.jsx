...
import './buttons.css';
import { AddIcon, DeleteIcon, DownloadIcon, EditIcon, FilterIcon, HideIcon, OnGoingIcon, SearchIcon, ViewIcon } from '../../asset/icons/button/index.js';
...
const Buttons = ({ type, className, style, onClick, context, count, setCount = () => {} }) => {
  ...
  const buttonStylesContexts = {
    ...
    proceed: 'bg-primary text-white rounded-md',
    in_progress: 'bg-primary text-white rounded-md',
  ...
  const buttonSizeContexts = {
    ...
    details: 'w-[70px] h-[35px] rounded-md',
    proceed: 'w-[150px] h-[45px] rounded-md',
    in_progress: 'w-[150px] h-[45px] rounded-md',
