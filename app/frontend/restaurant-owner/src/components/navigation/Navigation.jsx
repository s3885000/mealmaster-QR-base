...
const navItems = [
  { name: 'Home', Icon: HomeNav, ActiveIcon: HomeNavActive, path:'/home' }, //Home
  { name: 'Cart', Icon: CartNav, ActiveIcon: CartNavActive, path:'/cart' }, //Create QR
  { name: 'Scan QR', Icon: ScanQRNav, ActiveIcon: ScanQRNavActive, path:'/scanqr' }, // Table
