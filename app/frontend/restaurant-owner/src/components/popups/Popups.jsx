    ...
    'add_table': (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.addTableName && <p>Invalid</p>}
    ...
    'edit_table': (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.editTableName && <p>Invalid</p>}
    ...
    'add_category': (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.addCategoryName && <p>Invalid</p>}
    ...
    'edit_category': (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.editCategoryName && <p>Invalid</p>}
    ...
    'add_food': (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.description && <p>Invalid</p>}
