    ...
    <div className='p-4'>
      ...
      <div className={`bg-white px-6 py-4 rounded-3xl w-full`}>
        <form>
          ...
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="John" type="text" name="firstName" />

          <label className='block text-2xl font-bold'>Last Name</label>
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="Smith" type="text" name="lastName" />

          <label className='block text-2xl font-bold'>E-mail</label>
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="example@example.com" type="text" name="email" />
      ...
      <div className={`bg-white px-6 py-4 rounded-3xl w-full`}>
        <form>
          <label className="block place-self-center mb-5">
          ...
          <label className="block place-self-center mb-10">
          ...
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="Haidilao" type="text" name="restaurantName" />

          <label className='block text-2xl font-bold'>Address</label>
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="HCMC" type="text" name="restaurantAddress" />

          <label className='block text-2xl font-bold'>Contact E-mail</label>
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="example@example.com" type="text" name="email" />

          <label className='block text-2xl font-bold'>Contact Number</label>
          <input className="border border-gray rounded-md placeholder-slate-400 w-full p-2 mb-5" placeholder="1234567890" type="text" name="number" />
