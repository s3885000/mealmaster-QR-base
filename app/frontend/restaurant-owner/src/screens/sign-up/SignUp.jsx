    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex flex-col items-center justify-start flex-1 bg-white p-10 w-full md:w-1/2">
                ...
                <Buttons context="create_account_signup" className="mb-5" onClick={handleContinueClick}></Buttons>
                <Buttons context="already" className="mb-5" onClick={handleGuestClick}></Buttons>
            </div>
        </div>
    );
};
